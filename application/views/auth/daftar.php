<div class="container-fluid">
    ...
    <div class="card">
        <h6 class="card-header"><strong>PENDAFTARAN AKUN SIMPEG DISDIKBUD KAB. LEBAK</strong></h6>
        <div class="card-body">
            <!-- <form action="" method="post"> -->
            <!-- <?php echo form_open_multipart('admin/data_pegawai/tambah') ?> -->
            <form action="<?php echo base_url() ?>auth/daftar" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="form-row justify-content-md-center">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-7">
                            <input type="text" name="nm_pegawai" id="nm_pegawai" class="form-control" placeholder="Masukan Nama">
                        </div>
                    </div>
                </div>
                ...
                <!-- <div class="form-group">
                    <div class="form-row justify-content-md-center">
                        <div class="col-md-2 col-sm-2 col-xs-2 text-right mt-2">
                            <label for="nm_pegawai">Username</label>
                        </div>
                        <div class="col-md-7 col-sm-7 col-xs-7">
                            <input type="text" name="nm_pegawai" id="nm_pegawai" class="form-control" placeholder="Masukkan Username">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="form-row justify-content-md-center">
                        <div class="col-md-2 col-sm-2 col-xs-2 text-right mt-2">
                            <label for="nm_pegawai">Password</label>
                        </div>
                        <div class="col-md-7 col-sm-7 col-xs-7">
                            <input type="password" name="nm_pegawai" id="nm_pegawai" class="form-control" placeholder="Masukkan Password">
                        </div>
                    </div>
                </div> -->
                ...
                <div class="form-group">
                    <div class="form-row justify-content-md-center">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-7">
                            <input type="text" name="uk" id="uk" class="form-control" placeholder="Masukkan Unit Kerja">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <div class="form-row justify-content-md-center">
                        ...
                        <div class="col-md-7 col-sm-7 col-xs-7">
                            <input type="text" name="kec" id="kec" class="form-control" placeholder="Masukkan Kecamatan">
                        </div>
                    </div>
                <!-- </div>
                <div class="form-group">
                    <div class="form-row justify-content-md-center">
                        <div class="col-md-2 col-sm-2 col-xs-2 text-right mt-2">
                            <label for="nip">No Sertifikat Pendidik</label>
                        </div>
                        <div class="col-md-7 col-sm-7 col-xs-7">
                            <input type="text" name="sertifikat" id="sertifikat" class="form-control" placeholder="Masukkan No Seri">
                        </div>
                    </div>
                </div> -->
                ...
                <!-- <div class="form-group">
                    ...
                    <div class="form-row justify-content-md-center">
                    <div class="col-md-2 col-sm-2 col-xs-2 text-right mt-2">
                            <label for="tpt_lhr">Tanggal Pensiun</label>
                        </div>
                        
                        <div class="col-md-7 col-sm-7 col-xs-7">
                            <div class="form-row">
                                <div class="col-md-6 input-group">
                                    <input type="date" name="tgl_pnsn" id="tgl_pnsn" class="form-control" disabled>
                                    <div class="input-group-prepend">
                                        <div class="input-group-text"><i class="fas fa-calendar-alt"></i></div>
                                    </div>
                                </div>
...
<!-- 
                ...
                <div class="form-group">
                    <div class="form-row justify-content-md-center">
                        <div class="col-md-2 col-sm-2 col-xs-2 text-right mt-2">
                            <label for="tgl_knk_gj">Tanggal Kenaikan Gaji Terakhir</label>
                        </div>
                        <div class="col-md-7 col-sm-7 col-xs-7">
        ...
        <div class="card-footer text-center">
            <!-- <a href="<?php echo base_url('auth/daftar'); ?>" class="btn btn-danger btn-sm"><i class=" fas fa-arrow-left"></i> Kembali</a> -->
            <button type="submit" class="btn btn-primary btn-sm"> Selanjutnya <i class="fas fa-arrow-right"></i></button>
        </div>
