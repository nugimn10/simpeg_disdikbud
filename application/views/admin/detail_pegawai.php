                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-md-7">
                                                <table class="table table-borderless">
                                                    ...
                                                    <tr>
                                                        <th class="text-right">Kenaikan Gaji Berkala Berikutnya</th>
                                                        <!-- <td>: <?php echo $detail->tgl_knk_gj ?></td> -->
                                                    </tr>
                                                    ...
                                                    <ul class="list-group list-group-flush">
                                                        ...
                                                        <li class="list-group-item">
                                                            ...
                                                            <div class="col-md-2 text-left"><i class="fas fa-clipboard-list"></i></div>
                                                                ...
                                                                <div class="col-md-10 text-right"><a href="<?php echo base_url('admin/data_pegawai/ajukan'); ?>" class="btn btn-sm btn-primary"><i class="fas fa-sm fa-plus"></i> Ajukan Kenaikan Pangkat</a>
                                                                </div>
                                                            </div>
                                                        </li>
                                                    </ul>
                                ...
                                <div class="tab-pane fade" id="kelengkapan" role="tabpanel" aria-labelledby="kelengkapan-tab">
                                    ...
                                    <div class="row mt-3">
                                        <!-- <div class="col-md-6 mb-3">
                                            <a href="<?php echo base_url('admin/data_pegawai/upload'); ?>" class="btn btn-sm btn-primary"><i class="fas fa-sm fa-plus"></i> Upload Kelengkapan</a>
                                                
                                            <a href="<?php echo base_url('admin/data_pegawai/unduh'); ?>" class="btn btn-sm btn-primary"><i class="fas fa-sm fa-plus"></i> Unduh Kelengkapan</a>
                                        </div> -->
