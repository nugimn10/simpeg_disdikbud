                                            ...
                                            <div class="col-md-7">
                                                <table class="table table-borderless">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>: <?php if ($detail->agama == null) echo "";
                                                                else echo $detail->agama ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-right">Golongan Darah</th>
                                                        <td>: <?php if ($detail->gol_darah == null) echo "";
                                                                else  echo $detail->gol_darah ?></td>
                                                    </tr>
                                                    <tr>
                                                        <th class="text-right">Status Pernikahan</th>
                                                        <td>: <?php if ($detail->stts_pnkh == null) echo "";
                                                                else echo $detail->stts_pnkh ?></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>: <?php if ($detail->alamat == null) echo "";
                                                                else echo $detail->alamat ?></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>: <?php
                                                                ...
                                                                $new_date = date("d-m-Y", $timestamp);
                                                                if ($detail->tgl_knk_pkt == null) echo "";
                                                                else echo $new_date ?></td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>: <?php
                                                                ...
                                                                if ($detail->tgl_knk_gj == null) echo "";
                                                                else echo $new_date ?></td>
                                                    </tr>
                                                    <tr>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-10 text-right">
                                                                    ...
                                                                    <?php } else if ($detail->stts_knk_pkt == 9) { ?>
                                                                        <a class="btn btn-danger" href="<?php echo base_url('pegawai/kenaikan_pangkat/tms/' . $detail->id_pegawai); ?>">Tidak Memenuhi Syarat</a><br>
                                                                        <p></p>
                                                                    ...
                                                                    <?php } else if ($detail->stts_knk_pkt == 4) { ?>
                                                                        <a class="btn btn-warning" href="<?php echo base_url('pegawai/kenaikan_pangkat/btl/' . $detail->id_pegawai); ?>">Berkas Tidak Lengkap</a><br>
                                                                        <p></p>
                                                                        <textarea id="catatan" name="catatan" row="5" col="100%" class="md-textarea form-control" style="background-color:green;color:#fff;" disabled><?php echo $detail->catatan; ?></textarea>
