<div class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?php echo base_url('pegawai/kepegawaian/jabatan/edit/'. $detail->id_pegawai.'/'. $jabatan->id_jabatan) ?>" method="post">

            <div class="form-group">
        <div class="col-md-7 col-sm-7 col-xs-7">
        <input type="text" name="id_pegawai" class="form-control" value="<?php echo $detail->id_pegawai ?>" hidden>
        <input type="text" name="id_jabatan" class="form-control" value="<?php echo $jabatan->id_jabatan ?>" hidden>
        </div>
        ...
        <div class="col-md-7">
            <select name="id_master_eselon" class="custom-select">
                <?php foreach ($master_golongan as $me) : ?>
                    <?php if ($me->id_master_golongan == $jabatan->id_master_eselon) {?>
    ...
    <div class="form-row justify-content-md-center">
        ...
        <div class="col-md-7">
                <select name="id_master_jabatan" class="custom-select">
                    ...
                    <?php if ($mj->id_master_jabatan == $jabatan->id_master_jabatan) {?>
                    <option value="<?php echo $mj->id_master_jabatan ?>" selected><?php echo $mj->nm_jabatan ?></option>
                    <?php }else {?>
    ...
    <div class="form-row justify-content-md-center">
        ...
        <div class="col-md-7">
            ...
            <select name="jenis_jbt" class="custom-select">
                <option selected><?php echo $jabatan->jenis_jbt ?></option>
...
<div class="form-group">
    <div class="form-row justify-content-md-center">
        ...
        <div class="col-md-7">
            <div class="form-row">
                <div class="col-md-6">
                    <input type="text" name="no_sk_jbt" id="no_sk_jbt" class="form-control" placeholder="Masukkan No. SK" value="<?php echo $jabatan->no_sk_jbt ?>">
                </div>
                <div class="col-md-6 input-group">
                    <input type="date" name="tgl_sk_jbt" id="tgl_sk_jbt" class="form-control" value="<?php echo $jabatan->tgl_sk_jbt ?>">
        ...
        <div class="col-md-7">
            <div class="form-row">
                <div class="col-md-5 input-group">
                    <input type="date" name="awal_masa_jbt" id="awal_masa_jbt" class="form-control" value="<?php echo $jabatan->awal_masa_jbt ?>">
                    <div class="input-group-prepend">
                        <div class="input-group-text"><i class="fas fa-calendar-alt"></i></div>
                    </div>
                </div>
                ...
                <div class="col-md-5 input-group">
                    <input type="date" name="akhir_masa_jbt" id="akhir_masa_jbt" class="form-control" value="<?php echo $jabatan->akhir_masa_jbt ?>">
                    <div class="input-group-prepend">
                        <div class="input-group-text"><i class="fas fa-calendar-alt"></i></div>
                    </div>
                </div>
