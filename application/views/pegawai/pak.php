...
<table style="height: 35px; width: 100%; border-collapse: collapse;" border="0">
    <tbody>
        ...
        <td style="text-align:right; vertical-align:top; width: 15%; height: 30px;"><p>LAMPIRAN V:          </p></td>
...
<td style="border-left: hidden">&nbsp;</td>
<td  colspan="3">&nbsp;<?php echo $detail->nokarpeg;?></td>
</tr>
<tr style="height: 18px;">
<td >&nbsp;5</td>
...
foreach ($pak as $p2 ) {
    /* Do stuff */
    if ($p2->unsur == "MENGIKUTI PELATIHAN PRAJABATAN") break;
}?>
...
<td style="width: 12.2906%; height: 18px;" align="center">&nbsp;<?php $jml_u_utama_lama = ($p1->angka_lama + $p2->angka_lama + $p3lama + $p4->angka_lama + $p5->angka_lama + $p6->angka_lama)*1000; echo number_format($jml_u_utama_lama) ?></td>
<td style="width: 12.2906%; height: 18px;" align="center">&nbsp;<?php $jml_u_utama_baru = ($p1->angka_baru + $p2->angka_baru+ $p3baru + $p4->angka_baru + $p5->angka_baru + $p6->angka_baru)*1000; echo number_format($jml_u_utama_baru) ?></td>
...
<tr style="height: 18px;">
<td style="width: 3.04314%; height: 18px;">&nbsp;</td>
<td style="width: 35.0309%; height: 18px; text-align: left;" colspan="2">Melaksanakan Kegiatan yang mendukung tugas guru</td>
<?php 
foreach ($pak as $p8 ) {
    /* Do stuff */
...
<tr style="height: 18px;">
<td style="width: 3.04314%; height: 18px;">&nbsp;</td>
<td style="width: 35.0309%; height: 18px; text-align: left;" colspan="2">Memperoleh penghargaan/tanda jasa Satya Lencana Karya Satya</td>
<?php 
foreach ($pak as $p9 ) {
    /* Do stuff */
...
<td style="width: 12.2906%; height: 18px;" align="center">&nbsp;<?php $jml_u_penunjang_jumlah = $jp7+$jp8+$jp9; echo number_format($jml_u_penunjang_jumlah) ?></td>
</tr>
<tr style="height: 18px;">
...
<td style="width: 175.835%; height: 18px; text-align: left;" colspan="6">DAPAT DIPERTIMBANGKAN UNTUK DINAIKAN DALAM JABATAN</td>
</tr>
<tr style="height: 18px;">
...
<font size="12px" face="Courier New" >
<table border="0" style="border-collapse: collapse; width: 101.808%; height: 200px;">
<tbody>
...
<br />
<img src="<?php echo base_url()?>assets/img/barcode.jpg" width="90" height="90"><br>
<?php echo $surat_pak->nm_kadis?><br /><?php echo $surat_pak->pnkt?><br />NIP. <?php echo $surat_pak->nip_kadis ?></p></td>
</tr>
</tbody>
</table>
</font>
